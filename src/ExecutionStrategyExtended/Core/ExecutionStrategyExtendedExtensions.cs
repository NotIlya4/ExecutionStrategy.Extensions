...
public static class ExecutionStrategyExtendedExtensions
{
    ...
    {
        return strategyExtended.ExecuteAsync(action, strategyExtended.MainContext);
    }
    ...
    {
        return strategyExtended.ExecuteInTransactionAsync(action, strategyExtended.MainContext, isolationLevel);
    }
