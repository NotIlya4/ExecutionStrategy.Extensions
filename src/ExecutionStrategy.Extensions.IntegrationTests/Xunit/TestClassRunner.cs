...
public class TestClassRunner : XunitTestClassRunner
{
    ...
    {
        return new TestMethodRunner(_serviceProvider, SelectTestClassConstructor(),testMethod, Class, method, testCases, DiagnosticMessageSink, MessageBus, new ExceptionAggregator(Aggregator), CancellationTokenSource, constructorArguments).RunAsync();
    }
